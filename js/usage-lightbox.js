(() => {
  const images = document.querySelectorAll('.usage-step .usage-image, .proverb-illustration[data-lightbox], .hyakunin-sequence .learning-illustration[data-lightbox]');
